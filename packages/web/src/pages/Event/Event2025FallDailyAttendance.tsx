...
import { ModalEvent2025FallDailyAttendance } from "@/components/ModalPopup";
  ...
  return (
    <>
      ...
      >
        ...
        />
        {isToday ? (
          <ModalEvent2025FallDailyAttendance
...
export default memo(Event2025FallAttendance);
