...
interface Event2025FallStoreLeaderboardProps {
  itemId: string;
}

const Event2025FallStoreLeaderboard = ({
  itemId,
}: Event2025FallStoreLeaderboardProps) => {
  ...
  }, [item?._id, event2025FallInfo, purchaseAmount]);
...
export default Event2025FallStoreLeaderboard;
