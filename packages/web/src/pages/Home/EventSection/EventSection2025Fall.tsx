  ...
  return (
    <AdaptiveDiv type="center">
      ...
      <div css={{ display: "flex", gap: "15px" }}>
        <Link to="/event/2025fall" css={{ width: 0, flexGrow: 1 }}>
          <ButtonContainer
            title="이벤트 안내"
            description={
              <>
        ...
        <div css={{ width: 0, flexGrow: 1 }}>
          <Link to="/event/2025fall-missions">
            <ButtonContainer
              title="퀘스트"
              description={<>이지피지하게 달성하고 응모권 받기</>}
            >
...
export default EventSection2025Fall;
