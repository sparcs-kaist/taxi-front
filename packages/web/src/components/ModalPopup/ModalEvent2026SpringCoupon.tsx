...
type ModalEvent2026SpringCouponProps = Omit<
...
const ModalEvent2026SpringCoupon = ({
  setIsOpen,
  ...modalProps
}: ModalEvent2026SpringCouponProps) => {
  ...
  const onClickUse = useCallback(() => {
    axios({
      url: `/events/2026spring/items/useCoupon/${couponCode}`,
      method: "post",
      onSuccess: (data) => {
...
export default ModalEvent2026SpringCoupon;
