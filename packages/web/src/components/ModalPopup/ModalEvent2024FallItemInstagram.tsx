import { EventItem } from "@/types/event2024fall";
...
const backgroundLayerUrl =
  "https://sparcs-taxi-prod.s3.ap-northeast-2.amazonaws.com/assets/event-2023fall/instagram_background_item.png"; // ToDo : 2023fall S3 링크
...
type ModalEvent2024FallItemInstagramProps = { item?: EventItem } & Parameters<
  typeof Modal
>[0];
...
const ModalEvent2024FallItemInstagram = ({
  item,
  ...modalProps
}: ModalEvent2024FallItemInstagramProps) => {
...
export default ModalEvent2024FallItemInstagram;
