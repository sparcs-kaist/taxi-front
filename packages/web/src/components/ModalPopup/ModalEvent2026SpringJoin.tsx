...
type ModalEvent2026SpringJoinProps = Parameters<typeof Modal>[0] & {
  inviterId?: string;
  defaultPhoneNumber?: string;
};

const ModalEvent2026SpringJoin = ({
  inviterId,
  ...modalProps
}: ModalEvent2026SpringJoinProps) => {
  ...
  useEffect(() => {
    ...
    axios({
      url: `/events/2026spring/invites/search/${inviterId}`,
      method: "get",
      onSuccess: (data) => {
        setInviterInfo(data);
      },
  ...
  const onClickJoin = useCallback(
    ...
    [phoneNumber, setPhoneNumber, event2026SpringQuestComplete]
  );
...
export default ModalEvent2026SpringJoin;
