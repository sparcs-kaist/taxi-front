  ...
  return (
    <div style={styleBox}>
      ...
      <div style={styleContent}>
        ...
        대신, 회원 탈퇴하기를 통해 회원 탈퇴 의사를 밝혀주시면, Taxi팀이 확인한
        뒤 탈퇴를 처리해 드립니다. 정산이 완료되지 않은 방이 존재하는 경우,
        정산이 완료될 때까지 탈퇴가 불가능합니다.
      </div>
...
export default BodyFavoriteRoute;
