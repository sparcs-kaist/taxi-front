...
type BodyEvent2024SpringAbuseWarningProps = {
  onChangeIsOpen?: (isOpen: boolean) => void;
};

const BodyEvent2024SpringAbuseWarning = ({
  onChangeIsOpen,
}: BodyEvent2024SpringAbuseWarningProps) => {
  const styleText = {
    ...theme.font12,
...
export default BodyEvent2024SpringAbuseWarning;
