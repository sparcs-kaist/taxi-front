...
export type BodyEvent2026SpringShareProps = {
  inviteUrl: string;
  height?: number;
};

const BodyEvent2026SpringShare = ({
  height,
  inviteUrl,
  ...
  return (
    <div css={styleWrapper}>
      <div css={styleGuide}>
        ...
        <b>넙죽코인 500개</b>를 획득합니다. 새 참여자가 다른 사람을 초대하면
        <b>넙죽코인 200개</b>를 획득할 수 있습니다.
      </div>
      <DottedLine />
      <div css={{ flexGrow: 1 }} />
      ...
      <div css={styleButtonSection}>
        <LinkKakaotalkShare
          title={"Taxi 새학기 이벤트"}
          description={`Taxi 새학기 이벤트에 참여해 보세요! 이 링크로 참여하면 넙죽코인 500개를 획득할 수 있어요!`}
          imageUrl={
            ogServer
...
export default BodyEvent2026SpringShare;
