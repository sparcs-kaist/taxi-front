...
const Member = (props) => {
    const style = {
        height: '68px', width: '145px',
        background: '#FAF8FB', position: 'relative',
        borderRadius: '10px', border: '1px solid rgba(110, 54, 120, 0.05)',
...
const PopupSparcs = (props) => {
    ...
    const styleLine = {
        height: "1px", marginLeft: "15px", marginRight: "15px", marginTop: "10px",
        ...
        <animated.div style={ styleBgd }>
            ...
            <div style={{ position: 'absolute', top: '120px', bottom: '40px', left: '0px', right: '0px' }}>
                ...
                <div style={ style } className="lay_auto">
                    ...
                    onClick={ props.onClose }/>
                    <div style={ styleLine }/>
                    <div style={{ margin: '15px', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                        <Member name="이채영"/>
                        <Member name="최준영"/>
                        <Member name="최지헌"/>
                    </div>
